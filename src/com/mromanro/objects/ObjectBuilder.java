...
import com.mromanro.util.Geometry.Cylinder;
...
public class ObjectBuilder {
	...
	static class GeneratedData{
		...
		GeneratedData(float[] vertexData, List<DrawCommand> list){
	...
	static GeneratedData createCircle(Circle asteroid, int numPoints){
		int size = sizeOfCircleInVertices(numPoints);
		
		ObjectBuilder builder = new ObjectBuilder(size);
		
		builder.appendCircle(asteroid, numPoints);
		return builder.build();
	}
